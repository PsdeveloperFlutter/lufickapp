                        ...
                        child: Container(
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(snapshot.data!.forecast.forecastday[index].date.toString(),style: TextStyle(fontSize: 12),),
                              Text(snapshot.data!.forecast.forecastday[index].dateEpoch.toString(),style: TextStyle(fontSize: 12),),
                              Text("Max Temp :- "+snapshot.data!.forecast.forecastday[index].day.maxtempC.toString(),style: TextStyle(fontSize: 12),),
                              Text("Min Temp :- "+snapshot.data!.forecast.forecastday[index].day.mintempC.toString(),style: TextStyle(fontSize: 12),),
                            ],
                          ),
                        ),
                      ),
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        children: [
                          ...
                          SizedBox(height: 10,),
                          Text("Headline: " + snapshot.data!.alerts.alert[index].headline.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                          Text("Message Type: " + snapshot.data!.alerts.alert[index].msgtype.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                          Text("Severity: " + snapshot.data!.alerts.alert[index].severity.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                          Text("Urgency: " + snapshot.data!.alerts.alert[index].urgency.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                          Text("Areas: " + snapshot.data!.alerts.alert[index].areas.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                          Text("Category: " + snapshot.data!.alerts.alert[index].category.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                          Text("Certainty: " + snapshot.data!.alerts.alert[index].certainty.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                          Text("Event: " + snapshot.data!.alerts.alert[index].event.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                          Text("Note: " + snapshot.data!.alerts.alert[index].note.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                          Text("Effective: " + snapshot.data!.alerts.alert[index].effective.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                          Text("Expires: " + snapshot.data!.alerts.alert[index].expires.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                          Text("Description: " + snapshot.data!.alerts.alert[index].desc.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                          Text("Instruction: " + snapshot.data!.alerts.alert[index].instruction.toString(), style: TextStyle(fontSize: 15)),
                          SizedBox(height: 10,),
                        ],
                      ),
                    ),
